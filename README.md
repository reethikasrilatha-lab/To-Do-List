...
## 🔗 Live Demo
[View Live Demo](https://reethikasrilatha-lab.github.io/Todo-list/)
...
4. Click the delete icon/button to remove a task.
...
- Structuring a small, interactive JavaScript app
